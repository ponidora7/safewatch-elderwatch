...
# Compatibility mappings for legacy scripts and dashboard
from pathlib import Path
PROJECT_ROOT = Path(BASE_DIR)
OUTPUT_DIR = Path(PROCESSED_DIR)
BASE_DATA_DIR = Path(os.path.join(BASE_DIR, "data", "raw"))

DATASETS = {
    "fall_detection": {
        "path": BASE_DATA_DIR / "human_fall",
        "annotation_type": "yolo"
    },
    "smoke_fire": {
        "path": BASE_DATA_DIR / "fire_smoke_detection",
        "annotation_type": "yolo"
    },
    "person_detection": {
